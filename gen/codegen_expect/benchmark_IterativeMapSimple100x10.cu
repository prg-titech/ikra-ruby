...
struct array_command_6 {
    ...
    array_command_5 *input_1;
    __host__ __device__ array_command_6(int *result = NULL, array_command_4 *input_0 = NULL, array_command_5 *input_1 = NULL) : result(result), input_0(input_0), input_1(input_1) { }
};
struct array_command_8 {
    ...
    array_command_5 *input_1;
    __host__ __device__ array_command_8(int *result = NULL, array_command_6 *input_0 = NULL, array_command_5 *input_1 = NULL) : result(result), input_0(input_0), input_1(input_1) { }
};
...
struct array_command_12 {
    ...
    array_command_5 *input_1;
    __host__ __device__ array_command_12(int *result = NULL, array_command_10 *input_0 = NULL, array_command_5 *input_1 = NULL) : result(result), input_0(input_0), input_1(input_1) { }
};
...
__global__ void kernel_8(environment_t *_env_, int _num_threads_, int *_result_, int *_array_10_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_12_(_env_, _block_k_10_(_env_, _block_k_8_(_env_, _block_k_6_(_env_, _block_k_4_(_env_, _array_10_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_14(environment_t *_env_, int _num_threads_, int *_result_, int *_array_16_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_12_(_env_, _block_k_10_(_env_, _block_k_8_(_env_, _block_k_6_(_env_, _block_k_4_(_env_, _array_16_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_20(environment_t *_env_, int _num_threads_, int *_result_, int *_array_22_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_12_(_env_, _block_k_10_(_env_, _block_k_8_(_env_, _block_k_6_(_env_, _block_k_4_(_env_, _array_22_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_26(environment_t *_env_, int _num_threads_, int *_result_, int *_array_28_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_12_(_env_, _block_k_10_(_env_, _block_k_8_(_env_, _block_k_6_(_env_, _block_k_4_(_env_, _array_28_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_32(environment_t *_env_, int _num_threads_, int *_result_, int *_array_34_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_12_(_env_, _block_k_10_(_env_, _block_k_8_(_env_, _block_k_6_(_env_, _block_k_4_(_env_, _array_34_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12})), ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
variable_size_array_t _host_section__(environment_t *host_env, environment_t *dev_env, result_t *program_result)
{
    ...
    array_command_12 * _ssa_var_y_8;
    array_command_10 * _ssa_var_y_7;
    array_command_8 * _ssa_var_y_6;
    array_command_6 * _ssa_var_y_5;
    ...
    union_t _ssa_var_y_1;
    {
        ...
        for (r = 0; r <= (100 - 1); r++)
        {
                ...
                variable_size_array_t _polytemp_result_1;
                {
                    ...
                    switch (_polytemp_expr_2.class_id)
                    {
                        ...
                        case 12: /* [Ikra::Symbolic::ArrayCombineCommand, size = 60000000] (Ikra::Symbolic::ArrayCommand) */ _polytemp_result_1 = ({
                            // [Ikra::Symbolic::ArrayCombineCommand, size = 60000000]: [SendNode: [LVarReadNode: _ssa_var_y_7].pmap([HashNode: {<:with_index> => [BeginNode: {<true>}]}])]
                            ...
                            timeReportMeasure(program_result, allocate_memory);
                            timeStartMeasure();
                            kernel_8<<<58594, 1024>>>(dev_env, 60000000, _kernel_result_9, ((int *) ((int *) ((int *) ((int *) ((int *) ((int *) cmd->input_0->input_0->input_0->input_0->input_0->input_0.content)))))));
                            checkErrorReturn(program_result, cudaPeekAtLastError());
                            checkErrorReturn(program_result, cudaThreadSynchronize());
                            timeReportMeasure(program_result, kernel);
            ...
            _ssa_var_y_5 = new array_command_6(NULL, _ssa_var_y_4);
            _ssa_var_y_6 = new array_command_8(NULL, _ssa_var_y_5);
            _ssa_var_y_7 = new array_command_10(NULL, _ssa_var_y_6);
            _ssa_var_y_8 = new array_command_12(NULL, _ssa_var_y_7);
            ({
                bool _polytemp_result_9;
                {
                    ...
                    {
                        case 10: /* [Ikra::Symbolic::FixedSizeArrayInHostSectionCommand, size = 60000000] (Ikra::Symbolic::ArrayCommand) */ _polytemp_result_9 = ({
                        ...
                        case 12: /* [Ikra::Symbolic::ArrayCombineCommand, size = 60000000] (Ikra::Symbolic::ArrayCommand) */ _polytemp_result_9 = ({
                            array_command_12 * cmd_to_free = (array_command_12 *) _polytemp_expr_10.value.pointer;
            ...
            _ssa_var_y_1 = union_t(12, union_v_t::from_pointer((void *) _ssa_var_y_8));
            ...
            variable_size_array_t _polytemp_result_11;
            {
                ...
                switch (_polytemp_expr_12.class_id)
                {
                    ...
                    case 12: /* [Ikra::Symbolic::ArrayCombineCommand, size = 60000000] (Ikra::Symbolic::ArrayCommand) */ _polytemp_result_11 = ({
                        ...
                        array_command_12 * cmd = (array_command_12 *) _polytemp_expr_12.value.pointer;
                        ...
                        timeReportMeasure(program_result, allocate_memory);
                        timeStartMeasure();
                        kernel_32<<<58594, 1024>>>(dev_env, 60000000, _kernel_result_33, ((int *) ((int *) ((int *) ((int *) ((int *) ((int *) cmd->input_0->input_0->input_0->input_0->input_0->input_0.content)))))));
                        checkErrorReturn(program_result, cudaPeekAtLastError());
                        checkErrorReturn(program_result, cudaThreadSynchronize());
                        timeReportMeasure(program_result, kernel);
