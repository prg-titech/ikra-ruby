...
__global__ void kernel_36(environment_t *_env_, int _num_threads_, int *_result_)
{
...
extern "C" EXPORT result_t *launch_kernel(environment_t *host_env)
{
    ...
    /* Launch all kernels */
        timeStartMeasure();
    int * _kernel_result_37;
    checkErrorReturn(program_result, cudaMalloc(&_kernel_result_37, (sizeof(int) * 40000)));
    ...
    variable_size_array_t device_array = variable_size_array_t((void *) _kernel_result_37, 40000);
