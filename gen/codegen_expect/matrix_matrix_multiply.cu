...
extern "C" EXPORT result_t *launch_kernel(environment_t *host_env)
{
    ...
    checkErrorReturn(kernel_result, cudaMalloc((void **) &host_env->l2_a, 90000));
    checkErrorReturn(kernel_result, cudaMemcpy(host_env->l2_a, temp_ptr_l2_a, 90000, cudaMemcpyHostToDevice));

    void * temp_ptr_l2_b = host_env->l2_b;
    checkErrorReturn(kernel_result, cudaMalloc((void **) &host_env->l2_b, 90000));
    checkErrorReturn(kernel_result, cudaMemcpy(host_env->l2_b, temp_ptr_l2_b, 90000, cudaMemcpyHostToDevice));
    ...
    int *device_result;
    checkErrorReturn(kernel_result, cudaMalloc(&device_result, sizeof(int) * 22500));
    ...
    checkErrorReturn(kernel_result, cudaMemcpy(host_result, device_result, sizeof(int) * 22500, cudaMemcpyDeviceToHost));
