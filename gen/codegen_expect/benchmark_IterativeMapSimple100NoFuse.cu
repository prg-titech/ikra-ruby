...
__device__ int _block_k_2_(environment_t *_env_, indexed_struct_4_lt_int_int_int_int_gt_t indices)
{
    ...
    {
        return (((((((indices.field_0 + indices.field_1)) + indices.field_2)) + indices.field_3)) % 133777);
    }
}
...
__device__ int _block_k_4_(environment_t *_env_, int i, indexed_struct_4_lt_int_int_int_int_gt_t indices)
{
    ...
    {
        return (((((((((i + indices.field_0)) + indices.field_1)) + indices.field_2)) + indices.field_3)) % 13377);
    }
}
        ...
        for (i = 0; i <= (500 - 1); i++)
        {
            ...
            ({
                bool _polytemp_result_9;
                {
                    ...
                    {
                        case 10: /* [Ikra::Symbolic::FixedSizeArrayInHostSectionCommand, size = 10000000] (Ikra::Symbolic::ArrayCommand) */ _polytemp_result_9 = ({
