...
timeStartMeasure();
    ...
    int * _kernel_result_2_host = (int *) malloc((sizeof(int) * 30000000));
    kernel_1<<<29297, 1024>>>(dev_env, 30000000, _kernel_result_2);
    checkErrorReturn(program_result, cudaPeekAtLastError());
    checkErrorReturn(program_result, cudaThreadSynchronize());

    checkErrorReturn(program_result, cudaMemcpy(_kernel_result_2_host, _kernel_result_2, (sizeof(int) * 30000000), cudaMemcpyDeviceToHost));
