...
__global__ void kernel_8(environment_t *_env_, int _num_threads_, int *_result_, int *_array_10_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_10_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_14(environment_t *_env_, int _num_threads_, int *_result_, int *_array_16_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_16_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_20(environment_t *_env_, int _num_threads_, int *_result_, int *_array_22_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_22_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_26(environment_t *_env_, int _num_threads_, int *_result_, int *_array_28_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_28_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_29(environment_t *_env_, int _num_threads_, int *_result_, int *_array_31_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_31_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_32(environment_t *_env_, int _num_threads_, int *_result_, int *_array_34_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_34_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_35(environment_t *_env_, int _num_threads_, int *_result_, int *_array_37_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_37_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_38(environment_t *_env_, int _num_threads_, int *_result_, int *_array_40_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_40_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_41(environment_t *_env_, int _num_threads_, int *_result_, int *_array_43_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_43_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_44(environment_t *_env_, int _num_threads_, int *_result_, int *_array_46_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_46_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_47(environment_t *_env_, int _num_threads_, int *_result_, int *_array_49_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_49_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_50(environment_t *_env_, int _num_threads_, int *_result_, int *_array_52_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_52_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_53(environment_t *_env_, int _num_threads_, int *_result_, int *_array_55_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_55_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_56(environment_t *_env_, int _num_threads_, int *_result_, int *_array_58_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_58_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_59(environment_t *_env_, int _num_threads_, int *_result_, int *_array_61_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_61_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_62(environment_t *_env_, int _num_threads_, int *_result_, int *_array_64_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_64_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_65(environment_t *_env_, int _num_threads_, int *_result_, int *_array_67_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_67_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_68(environment_t *_env_, int _num_threads_, int *_result_, int *_array_70_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_70_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_71(environment_t *_env_, int _num_threads_, int *_result_, int *_array_73_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_73_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_74(environment_t *_env_, int _num_threads_, int *_result_, int *_array_76_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_76_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
__global__ void kernel_77(environment_t *_env_, int _num_threads_, int *_result_, int *_array_79_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _array_79_[_tid_];
    }
}
...
__global__ void kernel_80(environment_t *_env_, int _num_threads_, int *_result_, int *_array_82_)
{
    ...
    if (_tid_ < _num_threads_)
    {
        ...
        _result_[_tid_] = _block_k_4_(_env_, _array_82_[_tid_], ((indexed_struct_4_lt_int_int_int_int_gt_t) {_tid_ / 3000000, (_tid_ / 6000) % 500, (_tid_ / 12) % 500, (_tid_ / 1) % 12}));
    }
}
...
variable_size_array_t _host_section__(environment_t *host_env, environment_t *dev_env, result_t *program_result)
{
    ...
    union_t _ssa_var_y_1;
    {
        ...
        for (r = 0; r <= (100 - 1); r++)
        {
            ...
            _ssa_var_y_1 = union_t(12, union_v_t::from_pointer((void *) _ssa_var_y_11));
            _ssa_var_old_data_2 = union_t(12, union_v_t::from_pointer((void *) _ssa_var_old_data_12));
        }
        r--;
        return ({
            variable_size_array_t _polytemp_result_11;
            {
                ...
                switch (_polytemp_expr_12.class_id)
                {
                    case 10: /* [Ikra::Symbolic::FixedSizeArrayInHostSectionCommand, size = 60000000] (Ikra::Symbolic::ArrayCommand) */ _polytemp_result_11 = ({
                        ...
                        timeReportMeasure(program_result, allocate_memory);
                        timeStartMeasure();
                        kernel_77<<<58594, 1024>>>(dev_env, 60000000, _kernel_result_78, ((int *) cmd->input_0.content));
                        checkErrorReturn(program_result, cudaPeekAtLastError());
                        checkErrorReturn(program_result, cudaThreadSynchronize());
                        timeReportMeasure(program_result, kernel);
                    ...
                    case 12: /* [Ikra::Symbolic::ArrayCombineCommand, size = 60000000] (Ikra::Symbolic::ArrayCommand) */ _polytemp_result_11 = ({
                        ...
                        if (cmd->result == 0) {
                                timeStartMeasure();
                        int * _kernel_result_81;
                        checkErrorReturn(program_result, cudaMalloc(&_kernel_result_81, (sizeof(int) * 60000000)));
                        program_result->device_allocations->push_back(_kernel_result_81);
                        timeReportMeasure(program_result, allocate_memory);
                        timeStartMeasure();
                        kernel_80<<<58594, 1024>>>(dev_env, 60000000, _kernel_result_81, ((int *) ((int *) cmd->input_0->input_0.content)));
                        checkErrorReturn(program_result, cudaPeekAtLastError());
                        checkErrorReturn(program_result, cudaThreadSynchronize());
                        timeReportMeasure(program_result, kernel);
                            cmd->result = _kernel_result_81;
